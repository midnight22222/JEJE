...
# set repo
wget -O /etc/apt/sources.list "https://github.com/midnight22222/JEJE/blob/master/sources.list.debian7"
...
wget -O /etc/nginx/nginx.conf "https://github.com/midnight22222/JEJE/blob/master/nginx.conf"
...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://github.com/midnight22222/JEJE/blob/master/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://github.com/midnight22222/JEJE/blob/master/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
iptables -t nat -I POSTROUTING -s 192.168.100.0/24 -o eth0 -j MASQUERADE
iptables-save > /etc/iptables_yg_baru_dibikin.conf
wget -O /etc/network/if-up.d/iptables "https://github.com/midnight22222/JEJE/blob/master/iptables"
chmod +x /etc/network/if-up.d/iptables
service openvpn restart

# konfigurasi openvpn
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://github.com/midnight22222/JEJE/blob/master/client-1194.conf"
sed -i $MYIP2 /etc/openvpn/client.ovpn;
cp client.ovpn /home/vps/public_html/

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://github.com/midnight22222/JEJE/blob/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://github.com/midnight22222/JEJE/blob/master/badvpn-udpgw64"
fi
...
wget -O /etc/squid3/squid.conf "https://github.com/midnight22222/JEJE/blob/master/squid3.conf"
